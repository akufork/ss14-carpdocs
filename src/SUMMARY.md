...
- [Areas](mapping/areas/README.md)
  ...
  - [Command](mapping/areas/command/README.md)
    - [Bridge](mapping/areas/command/bridge.md)
    - [Captain’s Quarters](mapping/areas/command/captain.md)
      - [Bathroom](mapping/areas/command/captain_bathroom.md)
      - [Bedroom](mapping/areas/command/captain_bedroom.md)
      - [Office](mapping/areas/command/captain_office.md)
    - [HoP](mapping/areas/command/hop.md)
    - [Vault](mapping/areas/command/vault.md)
  - [Engineering](mapping/areas/engineering/README.md)
    - [AME](mapping/areas/engineering/ame.md)
    - [Atmospherics](mapping/areas/engineering/atmospherics.md)
